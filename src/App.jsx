...
import { Menu, X, ChevronLeft, ChevronRight, Send } from 'lucide-react';
...
const App = () => {
  ...
  const timeline = [
    ...
    { emoji: "🎉", date: "2025 · May", title: "180+ Students success" },
  ...
  const handleSubmitContact = async () => {
    ...
    const botToken = '8466272474:AAEVIjEGlTWiluwpK-ULtkqXs91Hv9uVuFA';
          ...
          <div className="flex items-center justify-center gap-8">
            {[-1, 0, 1].map((offset) => {
              ...
              return (
                <div
                  key={index}
                  className={`transition-all duration-500 ${offset === 0 ? 'scale-110 opacity-100' : 'scale-90 opacity-40 blur-sm'}`}
                >
                  <div className="bg-white rounded-xl shadow-xl p-8 w-64">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-bold hover:shadow-xl transition flex items-center justify-center gap-2"
          >
